...
namespace PlastikMarketim.Services
{
    ...
    public class PermissionAppService : ApplicationService, IPermissionAppService
    {
        ...
        private readonly IStringLocalizer<PlastikMarketimResource> _L;
        ...
        public PermissionAppService(
            ...
            IStringLocalizer<PlastikMarketimResource> L)
        {
        ...
        public virtual async Task<GetPermissionListResultDto> GetAsync(string providerName, string providerKey)
        {
            ...
            var newGroup = result.Groups.Where(x => x.Name == "NumuneTakip" || x.Name == "AbpIdentity").ToList();
