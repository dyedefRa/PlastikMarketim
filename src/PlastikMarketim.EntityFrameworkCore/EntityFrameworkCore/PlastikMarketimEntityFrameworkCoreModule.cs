...
{
    [DependsOn(
        typeof(PlastikMarketimDomainModule),
    ...
    public class PlastikMarketimEntityFrameworkCoreModule : AbpModule
    {
        ...
        {
            context.Services.AddAbpDbContext<PlastikMarketimDbContext>(options =>
            {
