...
namespace PlastikMarketim.Web.Pages.Account
{
    ...
    public class LoginModel : AccountPageModel
    {
        ...
        public virtual async Task<IActionResult> OnPostAsync(string action)
        {
            ...
            //if (userResult.ExtraProperties.TryGetValue("IsActive", out var isActive))
            //{
            //    if (!(bool)isActive)
            //    {
            //        await SignInManager.SignOutAsync();
            //        Alerts.Warning("Hesabınız aktif değil. Lütfen sistem yöneticisine başvurunuz.");
            //        return Page();
            //    }
            //}

            //if (userResult.ExtraProperties.TryGetValue("RoleName", out var roleName))
            //{
            //    if (roleName.ToString().ToLower() == "dealer")
            //    {
            //        await SignInManager.SignOutAsync();
            //        Alerts.Warning("Giriş yetkiniz yok.");
            //        return Page();
            //    }
            //}
